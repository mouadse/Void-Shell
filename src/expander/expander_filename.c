...
/*   Updated: 2024/12/18 03:41:55 by msennane         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// static void process_argument2(char *arg, t_queue_char *queue, int
// *exit_status,
//                               t_shell_context *context) {
//   int i;
//   int *values[2];
...
static void handle_single_quotes2(char *str, int *index, t_queue_char *queue,
  ...
  // We found a single quote, mark as quoted
  (*was_quoted) = 1;
...
static void handle_double_quotes2(char *arg, int *values[2], t_queue_char *q,
  ...
  // We found a double quote, mark as quoted
  (*was_quoted) = 1;
...
char *clean_argument2(char *arg, t_shell_context *context, int *exit_status) {
  ...
  char *cleaned_arg;
  char *home;
  int was_quoted = 0; // Track if we encountered quotes
  ...
  // Now cleaned_arg is the processed filename, and was_quoted tells us if
  // quotes were encountered. You can use was_quoted as needed.
